...
# Organisation DragonflyDataFactroy
# Default attribute list for hazelcast
default['hazelcast']['version']="3.5"
#default['hazelcast']['url'] = "http://www.hazelcast.com/files/hazelcast-#{node['hazelcast']['version']}.zip"
default['hazelcast']['url'] = "http://52.4.146.113:8081/artifactory/simple/Licensed_Softwares/hazelcast/hazelcast/3.5/hazelcast-3.5.zip"
...
default['hazelcast']['network_tcp_ip_interface']="$(hostname -i)"
default['hazelcast']['network_aws_enabled']="false"
default['hazelcast']['network_aws_access_key']="AKIAI5LJBI2E7CGKZAOA"
default['hazelcast']['network_aws_secret_key']="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"
default['hazelcast']['network_aws_region']="us-east-1"
